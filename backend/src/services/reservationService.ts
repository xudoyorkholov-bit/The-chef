...
export class ReservationService {
  ...
  async createReservation(data: CreateReservationRequest, userId?: string): Promise<Reservation> {
    try {
  ...
  async updateReservation(id: string, data: Partial<Reservation>, userId?: string): Promise<Reservation> {
    try {
  ...
  async filterReservations(filters: { date?: string; name?: string; status?: string }): Promise<Reservation[]> {
    try {
